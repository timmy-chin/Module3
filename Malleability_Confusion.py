...
# Bob decrypts message using s
k2 = SHA256.new(str(s).encode()).hexdigest()[:16].encode()
decrypted_message = aes_decrypt(k2, c0, iv)

print(f"Alice sent: {message}")
print(f"Bob decrypted message no longer works: {decrypted_message}")
